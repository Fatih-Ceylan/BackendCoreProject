...
{
    public class CustomerGetByIdVM : BaseVM
    {
        ...
        public ICollection<CustomerAddressGetByIdVM> CustomerAddress { get; set; }

        public ICollection<CustomerContactListVM> CustomerContacts { get; set; }

        //public ICollection<CustomerContactVM> CustomerContact { get; set; }
