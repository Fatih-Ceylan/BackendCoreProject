...
{
    public class IsDeletedEmployeeHandler : IRequestHandler<IsDeletedEmployeeRequest, IsDeletedEmployeeResponse>
    {
        private readonly IMapper _mapper;
        private readonly IEmployeeReadRepository _employeeReadRepository;

        public IsDeletedEmployeeHandler(IEmployeeReadRepository employeeReadRepository, IMapper mapper)
        {
            _employeeReadRepository = employeeReadRepository;
            _mapper = mapper;
        }

        public async Task<IsDeletedEmployeeResponse> Handle(IsDeletedEmployeeRequest request, CancellationToken cancellationToken)
        {
            var queryable = _employeeReadRepository.GetAllDeletedStatusDesc(true, true);
            ...
            return new IsDeletedEmployeeResponse
            {
