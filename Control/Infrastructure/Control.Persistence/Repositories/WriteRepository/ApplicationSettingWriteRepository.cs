...
{
    public class ApplicationSettingWriteRepository : T.WriteRepository<BaseProjectDbContext, ApplicationSetting>, IApplicationSettingWriteRepository
    {
        public ApplicationSettingWriteRepository(BaseProjectDbContext context) : base(context)
        {
        }
    }
}
