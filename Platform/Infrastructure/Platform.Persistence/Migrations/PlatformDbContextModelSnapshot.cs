            ...
            modelBuilder.Entity("CompanyCompanyFile", b =>
                {
                    ...
                    b.ToTable("CompanyCompanyFile", (string)null);
                });
            ...
            modelBuilder.Entity("GModuleGModuleFile", b =>
                {
                    ...
                    b.ToTable("GModuleGModuleFile", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.Definitions.GModule", b =>
                {
                    ...
                    b.ToTable("GModules", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.Definitions.GModuleLicenseTypePrice", b =>
                {
                    ...
                    b.ToTable("GModuleLicenseTypePrices", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.Definitions.LicenseDetail", b =>
                {
                    ...
                    b.ToTable("LicenseDetails", (string)null);
                });
            ...
            modelBuilder.Entity("Platform.Domain.Entities.Definitions.Order", b =>
                {
                    ...
                    b.Property<string>("BuyerDeliverAddress")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("BuyerInvoiceCity")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BuyerInvoiceCountry")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BuyerInvoiceDistrict")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BuyerInvoiceTaxNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BuyerInvoiceTaxOffice")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BuyerInvoiceTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("GeneralTotalDiscountAmount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<Guid?>("OrderIdFromModule")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Platform.Domain.Entities.Definitions.OrderDetail", b =>
                {
                    ...
                    b.Property<string>("PurchasedForStaffName")
                        .HasColumnType("nvarchar(max)");
