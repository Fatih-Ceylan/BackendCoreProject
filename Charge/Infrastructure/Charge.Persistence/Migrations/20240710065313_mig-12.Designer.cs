...
namespace GCharge.Persistence.Migrations
{
    ...
    [Migration("20240710065313_mig-12")]
    partial class mig12
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.ChargePoint", b =>
                {
                    ...
                    b.Property<string>("ElectricitySalesPriceId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid?>("ElectricitySalesPriceId1")
                    ...
                    b.HasIndex("ElectricitySalesPriceId1");
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.ChargePoint", b =>
                {
                    b.HasOne("GCharge.Domain.Entities.Definitions.ElectricitySalesPrice", "ElectricitySalesPrice")
                        .WithMany("ChargePoints")
                        .HasForeignKey("ElectricitySalesPriceId1");

                    b.Navigation("ElectricitySalesPrice");
                });
