...
namespace GCharge.Persistence.Migrations
{
    ...
    [Migration("20240710124511_mig-19")]
    partial class mig19
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.UserTransaction", b =>
                {
                    ...
                    b.Property<Guid?>("UserChargeTagId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.UserTransaction", b =>
                {
                    b.HasOne("GCharge.Domain.Entities.Definitions.UserChargeTag", "UserChargeTag")
                        .WithMany()
                        .HasForeignKey("UserChargeTagId");

                    b.Navigation("UserChargeTag");
                });
