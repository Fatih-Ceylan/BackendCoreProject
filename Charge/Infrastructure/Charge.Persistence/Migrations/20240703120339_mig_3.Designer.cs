...
namespace GCharge.Persistence.Migrations
{
    ...
    [Migration("20240703120339_mig_3")]
    partial class mig_3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.UserChargeTag", b =>
                {
                    ...
                    b.Property<bool>("IsPhysicalCard")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("GCharge.Domain.Entities.Definitions.UserChargeTag", b =>
                {
                    b.HasOne("GCharge.Domain.Entities.Definitions.ChargeTag", "ChargeTag")
                        .WithMany("UserChargeTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_UserChargeTags_ChargeTags");
                    ...
                    b.HasOne("GCharge.Domain.Entities.Identity.AppUser", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("FK_UserChargeTags_AspNetUsers");
